    ...
    <div className="min-h-screen flex items-center justify-center bg-cream-bg px-4 py-12">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="mt-3 text-text-muted text-sm">Sign in to continue</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-clay-muted/30 p-8 space-y-4">
          ...
          {/* Google */}
          {googleError && (
            <div className="text-sm text-red-600 bg-red-50 border border-red-200 rounded-lg px-4 py-3">{googleError}</div>
          )}
          <button
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2 mb-1">
              ...
              <label className="text-sm font-medium text-charcoal">Continue with ORCID</label>
              <span className="text-xs text-text-muted">(Researchers only)</span>
            </div>
            <div className="flex gap-2">
              <input
                ...
                onKeyDown={(e) => e.key === "Enter" && handleOrcidLogin()}
            ...
            <p className="text-xs text-text-muted">Your ORCID ID links your real research profile from OpenAlex automatically.</p>
          </div>
        </div>
